...
import { Check, ArrowRight, BookOpen, Zap, TrendingUp, Users } from 'lucide-react';
import { useContactForm } from '@/contexts/ContactFormContext';

export default function AIOperationsConsultingPage() {
  const { openContactForm } = useContactForm();
  const benefits = ['Strategic AI roadmap development', 'Operational efficiency planning', 'Technology stack optimization', 'Change management support', 'ROI maximization', 'Risk mitigation strategies'];
  const features = [
    { icon: BookOpen, title: 'Strategy Development', description: 'Comprehensive AI strategy planning', color: 'from-blue-500 to-blue-600' },
    { icon: Zap, title: 'Implementation Planning', description: 'Detailed execution roadmaps', color: 'from-indigo-500 to-indigo-600' },
    { icon: TrendingUp, title: 'Performance Optimization', description: 'Continuous improvement cycles', color: 'from-orange-500 to-orange-600' },
    { icon: Users, title: 'Team Support', description: 'Training and change management', color: 'from-green-500 to-green-600' },
  ];
  const faqs = [
    { question: 'What is AI operations consulting?', answer: 'Strategic consulting to help enterprises develop and implement AI-driven operational strategies for business transformation.' },
    { question: 'Who should engage in AI consulting?', answer: 'Any enterprise looking to modernize operations, reduce costs, or gain competitive advantage through intelligent systems.' },
    { question: 'How long does consulting engagement last?', answer: 'Engagements typically run 3-6 months with ongoing optimization support available.' },
    { question: 'What deliverables are included?', answer: 'Strategy documents, implementation roadmaps, cost-benefit analysis, risk assessment, and executive presentations.' },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <motion.div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-full px-4 py-2 mb-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
              ...
              <span className="text-sm font-medium text-blue-700">Strategic AI Consulting • Operational Excellence • Digital Transformation</span>
            </motion.div>
            ...
            <motion.p className="text-lg text-slate-600 mb-6 leading-relaxed max-w-3xl mx-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.25 }}>
              Strategic consulting to develop and implement AI-driven operational strategies that transform your business at scale.
            </motion.p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-900 via-slate-900 to-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-6">Begin Your AI Transformation</h2>
