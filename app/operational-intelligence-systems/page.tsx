...
import { Check, ArrowRight, Eye, TrendingUp, Zap, BarChart3 } from 'lucide-react';
...
export default function OperationalIntelligencePage() {
  ...
  const benefits = [
    ...
    'Predictive insights powered by AI analytics',
    'Automated performance dashboards and alerts',
    'Data-driven decision making at all levels',
    'Identify bottlenecks before they impact business',
  ...
  const features = [
    {
      ...
      description: 'Live visibility into operational metrics and KPIs',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: Zap,
      title: 'Predictive Analytics',
      description: 'AI models that forecast trends and issues',
      color: 'from-indigo-500 to-indigo-600',
    },
    {
      icon: BarChart3,
      title: 'Automated Reporting',
      description: 'Intelligent reports generated automatically',
      color: 'from-orange-500 to-orange-600',
    },
    {
      icon: TrendingUp,
      title: 'Performance Optimization',
      description: 'Continuous recommendations for improvement',
  ...
  const faqs = [
    {
      ...
      answer:
        'Operational intelligence uses real-time data analysis and AI to provide actionable insights into business processes, enabling proactive decision-making and continuous optimization.',
    },
    {
      question: 'How does it differ from business intelligence?',
      answer:
        'While BI focuses on historical data and reporting, operational intelligence provides real-time insights and predictive recommendations for immediate operational improvement.',
    },
    {
      question: 'Can you integrate with existing systems?',
      answer:
        'Yes, we integrate with all major business systems including CRM, ERP, supply chain, and custom databases to provide unified operational visibility.',
    },
    {
      question: 'What results can we expect?',
      answer:
        'Typical results include 25-40% efficiency improvements, 30% cost reduction, faster decision-making, and improved customer satisfaction.',
    },
  ];
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-blue-700">
                Enterprise Visibility • AI-Powered Analytics • 50+ Deployments
              </span>
            </motion.div>
            ...
            >
              Deploy AI-powered operational intelligence to gain real-time visibility, predictive insights, and automated decision support across your entire business.
            </motion.p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-900 via-slate-900 to-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-6">Deploy Operational Intelligence Today</h2>
            <p className="text-lg text-slate-300 mb-8">
              Gain real-time visibility and predictive insights into your operations with AI-powered intelligence systems.
            </p>
            <motion.button
              onClick={openContactForm}
